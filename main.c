...
void draw_wave_selection(int x, int y, int width, int height) {
    ...
    plot_image_sine(x + 5, y + 10);
    plot_image_sawtooth(x + 65, y + 10);
    plot_image_square(x + 125, y + 10);
    plot_image_triangle(x + 185, y + 10);
}
...
void draw_main_screen() {
    draw_wave_selection(40, 20, 240, 40);
    draw_waveform(40, 80, 160, 80);
    draw_keybd(40, 180, 240, 40);
    draw_adsr(220, 80, 60, 80);
}